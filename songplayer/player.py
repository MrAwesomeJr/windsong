...
class TimedPlayer:
    ...
    def play_keyboard(self, song, countdown: int = default_countdown, end_playback_beat=None, debug=False):
    ...
    def play_drum(self, song, countdown: int = default_countdown, end_playback_beat=None, debug=False):
        song = song.sorted_song()
        time.sleep(countdown)
        start_time = time.perf_counter()
        time_elapsed = 0
